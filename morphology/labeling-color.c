...
process(pnm ims, char* imd_char){
  ...
  unsigned short* out_r = malloc(sizeof(unsigned short) * w * h);
  unsigned short* out_g = malloc(sizeof(unsigned short) * w * h);
  unsigned short* out_b = malloc(sizeof(unsigned short) * w * h);
  ...
  pnm_set_channel(imd, out_r, 0);
  pnm_set_channel(imd, out_g, 1);
  pnm_set_channel(imd, out_b, 2);
